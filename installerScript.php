<?php
/**
 * @package plugin.content syntaxhighlighterghsvs for Joomla!
 * @version See syntaxhighlighterghsvs.xml
...
class plgContentSyntaxHighlighterGhsvsInstallerScript extends InstallerScript
{
